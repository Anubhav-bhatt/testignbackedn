    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                {/* HERO SECTION */}
                <View style={[styles.heroCard, { backgroundColor: theme === 'dark' ? colors.surface : '#FFF' }]}>
                ...
                {/* RECENT TRANSACTIONS */}
                <View style={[styles.card, { backgroundColor: theme === 'dark' ? colors.surface : '#FFF' }]}>
                ...
                {/* NEXT STEPS */}
                <View style={[styles.aiSection, { backgroundColor: theme === 'dark' ? '#1E293B' : '#EEF2FF', marginTop: 24 }]}>
                    <View style={styles.aiHeader}>
                        <Ionicons name="sparkles" size={18} color={colors.primary} />
                        <Text style={[styles.aiTitle, { color: colors.primary }]}>AI Intelligence Insight</Text>
                    </View>
                    <Text style={[styles.aiText, { color: theme === 'dark' ? '#94A3B8' : '#475569', marginBottom: 16 }]}>
                        This case is in {caseData.status}. Financial health is {caseData.pendingAmount > 5000 ? 'critical' : 'stable'}. Recommendation: Review the last {caseData.documentCount} documents before the hearing on {caseData.nextHearing}.
                    </Text>

                    <TouchableOpacity
                        style={[styles.aiChatBtn, { backgroundColor: colors.primary }]}
                        onPress={() => router.push({
                            pathname: "/ai",
                            params: {
                                caseId: caseData.id,
                    ...
                    >
                        ...
                        <Text style={styles.aiChatBtnText}>Consult AI Strategy</Text>
                    </TouchableOpacity>
                </View>
...
function InsightCard({ icon, label, value, color, bg }: any) {
    const { colors, theme } = useTheme();
    return (
        <View style={[styles.insightCard, { backgroundColor: theme === 'dark' ? colors.surface : bg }]}>
...
const styles = StyleSheet.create({
    ...
    heroCard: { padding: 20, borderRadius: 24, marginBottom: 20 },
    ...
    insightCard: { flex: 1, padding: 16, borderRadius: 20, gap: 8 },
    ...
    aiSection: { padding: 20, borderRadius: 24 },
